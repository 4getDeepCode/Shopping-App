...
import { DropdownMenuLabel, DropdownMenu, DropdownMenuTrigger, DropdownMenuContent, DropdownMenuItem, DropdownMenuSeparator } from '../ui/dropdown-menu';
    ...
    <header className="fixed top-0 z-40 w-full border-b bg-background">
      <div className="flex h-16 items-center justify-between px-4 md:px-6">
        ...
        <Sheet open={openMobileMenu} onOpenChange={setOpenMobileMenu}>
          ...
          <SheetContent side="left" className="w-full max-w-xs pl-6 pr-4 py-4">
            <MenuItems />
            <HeaderRightContent />
          </SheetContent>
        </Sheet>
